    ...
    try {
      ...
      if (data) {
        const tesista: SearchedTesista = {
          id: data.users[0].id,
          dni: data.users[0].dni || '',
          codigo_matricula: data.users[0].codigo_matricula || '',
          email: data.users[0].email,
          first_name: data.users[0].first_name,
          last_name: data.users[0].last_name,
          full_name: data.users[0].full_name,
          student_id: data.users[0].student_id,
          major: data.users[0].major,
          ...
          proyecto: {
            ...
            titulo: data.titulo,
            estado: data.estado,
            linea_investigacion: data.research_lines?.[0]?.nombre || '',
      ...
      if (data) {
        ...
        const tesista: SearchedTesista = {
          ...
          proyecto: proyecto ? {
            ...
            linea_investigacion: proyecto.research_lines?.[0]?.nombre || '',
